...
@synthesize redBlockScore, blueBlockScore, blockCounterRed, blockCounterBlue, blueAutoScore, blueBonusScore, blueEndGameScore, redAutoScore, redBonusScore, redEndGameScore;


- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    sleep(3);  // launch image for 3 seconds
...
-(void)initializeStoryBoardBasedOnScreenSize {
    ...
    {    // The iOS device = iPhone or iPod Touch
        ...
        {   // iPhone 3GS, 4, and 4S and iPod Touch 3rd and 4th generation: 3.5 inch screen (diagonally measured)
            ...
            UIStoryboard *iPhone4Storyboard = [UIStoryboard storyboardWithName:@"Main_Storyboard_iPhone4" bundle:nil];
